...
<aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Edit Profile <b><u><?php echo $_SESSION['fullname'] ?></u></b>
                        <small></small>
                    </h1>
                    <ol class="breadcrumb">
...
<div class="timeline-body"><div class="modal-body">
       <div class="col-lg-6">
                                                <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control"  id="text" value="<?php echo $_SESSION['username'] ?>" required name="profesi" disabled="disabled">
                                                </div></div>
                           <div class="col-lg-6">
                                                <div class="form-group">
                                                  
                                                  <input type="password"class="form-control password"  id="text"  required name="password" value="123456789" disabled="disabled">
                                                </div>
                                                </div>
                                                </div>
                                ...
                                <li>
                                  <i class="fa fa-user bg-blue"></i>
                                    <div class="timeline-item">
                                        ...
                                        <h3 class="timeline-header"><a href="#"><?php echo $_SESSION['fullname'] ?></a></h3>
                                        <div class="timeline-body">
                                         <img src="../upload/img_profil/<?php echo $_SESSION['img_user'] ?>" height="100"></div>
                                        <div class='timeline-footer'>
...
$query_hapus = mysql_query("select img_user from user where id_user='$_SESSION[id_user]'") or die(mysql_error());
...
$query = mysql_query(" update user set img_user='$nama_file', fullname='".$_POST['fullname']."' where id_user='$_SESSION[id_user]'")
 or die(mysql_error());
 if ($query) {
...
$query = mysql_query(" update user set username='".$_POST['username']."', password='".$_POST['password']."' where id_user='$_SESSION[id_user]'")
 or die(mysql_error());
 if ($query) {
